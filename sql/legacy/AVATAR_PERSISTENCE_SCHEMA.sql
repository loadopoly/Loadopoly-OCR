...
-- Ensure DISPLAY_NAME column exists if table was created in previous turn
ALTER TABLE world_sectors ADD COLUMN IF NOT EXISTS DISPLAY_NAME TEXT NOT NULL DEFAULT 'Sector';
ALTER TABLE world_sectors RENAME COLUMN LAST_UPDATED TO UPDATED_AT;
ALTER TABLE world_sectors ALTER COLUMN UPDATED_AT SET DEFAULT NOW();
