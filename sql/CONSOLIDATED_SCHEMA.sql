...
-- ============================================================
-- Bakugo (card centering) — same Supabase project, not OCR docs
-- Source of truth: supabase/migrations/20260820000000_bakugo_scans.sql
-- Photos stay on-device. Anon may SELECT/INSERT metadata only.
-- ============================================================
