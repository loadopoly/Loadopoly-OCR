      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-white flex items-center gap-3">
            Social Hub
            <span className="px-2 py-0.5 bg-primary-500/10 border border-primary-500/20 rounded text-[10px] text-primary-400 font-mono uppercase tracking-widest">v2.9.11</span>
          </h2>
