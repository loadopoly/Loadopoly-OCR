...
export default function StatusBar({ 
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-slate-950/80 backdrop-blur-md border-t border-slate-800 px-2 sm:px-4 py-1.5 flex items-center justify-between z-50 text-[10px] font-medium text-slate-500" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 6px)' }}>
